...
review:
    - questions:
        question: >
            What's KleidiAI ?
        answers:
            - An anime about a little AI lost in in giant world.
            - A software library
        correct_answer: 2
        explanation: >
    ...
    - questions:
        question: >
            How does KleidiAI optimize performances ?
        answers:
        ...
        explanation: >
            ...
            the software to use specific instruction dedicated to efficiently perform some
            task or computation. For example, when implemented, ``FEAT_DotProd`` adds the
