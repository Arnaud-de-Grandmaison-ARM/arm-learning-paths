...
docker run --rm -v "$PWD:/work" -w /work arnauddegrandmaison440/sme2-learning-path:sme2-environment-v1 make
...
The above ``make`` command (executed within the docker ``arnauddegrandmaison440/sme2-learning-path:sme2-environment-v1`` environment) is:
...
```BASH
$ docker run --rm -v "$PWD:/work" -w /work arnauddegrandmaison440/sme2-learning-path:sme2-environment-v1 make clean
```
{{% /notice %}}
...
docker run --rm -v "$PWD:/work" -w /work arnauddegrandmaison440/sme2-learning-path:sme2-environment-v1 ./run-fvp.sh hello
Hello, world !
...
```BASH
docker run --rm -v "$PWD:/work" -w /work arnauddegrandmaison440/sme2-learning-path:sme2-environment-v1 ./run-fvp.sh sme2_check
```
