...
loading of the data is very efficient ; this implementation details which
corresponds essentially to some unrolling of the main loop allows to improve yet
