...
```SH
docker run --rm -v "$PWD:/work" -w /work arnauddegrandmaison440/sme2-learning-path:sme2-environment-v1 COMMAND ARGUMENTS
```

This invokes docker, using the
``arnauddegrandmaison440/sme2-learning-path:sme2-environment-v1``container
