...
```BASH
docker run --rm -v "$PWD:/home/ubuntu/work" -w /home/ubuntu/work sme2-environment make sme2_matmul_asm
```

Then execute ``sme2_matmul_asm`` on the FVP:

```BASH
docker run --rm -v "$PWD:/home/ubuntu/work" -w /home/ubuntu/work sme2-environment ./run-fvp.sh sme2_matmul_asm
```
